...
try:
    ...
    agentic_path = Path(__file__).parent / "agentic_test_gen"
...
def main():
    ...
    with st.sidebar:
        ...
        # Navigation options - show agentic workflow only if available
        nav_options = ["🔧 XSD to XML Generation", "🔄 XML Transformation"]
        if agentic_system_available:
            nav_options.append("🤖 Agentic XSLT Analysis")
        
        # Determine current index
        current_index = 0
        if st.session_state['current_section'] == 'XML Transformation':
            current_index = 1
        ...
        if current_section == "🔧 XSD to XML Generation":
            st.session_state['current_section'] = 'XSD to XML Generation'
        elif current_section == "🔄 XML Transformation":
            st.session_state['current_section'] = 'XML Transformation'
        else:  # Agentic XSLT Analysis
            st.session_state['current_section'] = 'Agentic XSLT Analysis'
