...
If you have configurations using the old `values` format, convert them as follows:
...
The new format provides more flexibility and consistency across the entire configuration system.